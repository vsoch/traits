...
def get_behavior_synset(behavior,nid=0):
    synsets = dict()
...
def save_behaviors(input_file="data/tsv/cogPheno_782.tsv",
                  output_file="data/pickle/behavioraltraits.pkl"):
    cogpheno = pandas.read_csv(input_file,sep="\t")
...
def load_behaviors(input_pickle="data/pickle/behavioraltraits.pkl"):
